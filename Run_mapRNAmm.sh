...
mkdir -p /rds/user/mb2453/hpc-work/mapRNA_mm/${project}
out=/rds/user/mb2453/hpc-work/mapRNA_mm
mkdir -p $out/${project}/me_${acc}
cd $out/${project}/me_${acc}
raw="/home/mb2453/rds/hpc-work/fastq/${project}_fastq"
myscripts=/home/mb2453/000Scripts
#! Run options for the application:
options="${myscripts}/map_RNAmm.sh ${acc} ${project}"

#! Work directory (i.e. where the job will run):
workdir="${out}/${project}/me_${acc}"
