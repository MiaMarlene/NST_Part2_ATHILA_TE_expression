...
#! Each task is allocated 1 CPU by default, and each CPU is allocated 3380 MiB memory. If this is insufficient, also specify
...
#samples='/home/mb2453/rnaseq/fastq/PRJEB9919/mysamples'
#file=$(awk "NR==$SLURM_ARRAY_TASK_ID" $samples)
...
out='/rds/user/mb2453/hpc-work/mygenome'
#mkdir -p $out/me_{$file}
#raw='/home/mb2453/rnaseq/fastq/PRJEB9919'

#! Run options for the application:
myscripts=/home/mb2453/000Scripts
options="$myscripts/index_genome.sh"

#! Work directory (i.e. where the job will run):
workdir="/rds/user/mb2453/hpc-work/mygenome"  # The value of SLURM_SUBMIT_DIR sets workdir to the directory
