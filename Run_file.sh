...
##SBATCH --no-requeue
#SBATCH --array=1-12 #CHANGE THIS FOR NUMBER OF SAMPLES
...
#Choose whether or not you are selecting from PE or SE list
#file_project='/home/mb2453/rnaseq/fastq/sample_list/project_PE_lst'
#file_project='/home/mb2453/rnaseq/fastq/sample_list/project_SE_lst'
project="PRJNA280957"
file_sample="/home/mb2453/rnaseq/fastq/sample_list/${project}"
sample=$(awk "NR==$SLURM_ARRAY_TASK_ID" ${file_sample})
...
#mkdir -p /rds/user/mb2453/hpc-work/mapRNA
#out='/rds/user/mb2453/hpc-work/mapRNA'
#out=/rds/user/mb2453/hpc-work/fastq
mkdir -p /rds/user/mb2453/hpc-work/fastq/${project}_fastq
out=/rds/user/mb2453/hpc-work/fastq/${project}_fastq
cd $out
#cd $out/me_${file}
#raw='/home/mb2453/rnaseq/fastq/PRJEB9919'
myscripts=/home/mb2453/000Scripts
#! Run options for the application:
options="${myscripts}/file_download.sh ${sample} ${project}"
